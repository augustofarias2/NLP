...
dataset.append((0, "alguna actividad importante para hacer?"))
dataset.append((0, "hacer algo"))
dataset.append((0, "algo para hacer en la ciudad"))
dataset.append((0, "alguna actividad divertida para hacer?"))
dataset.append((0, "Decime algo para hacer acá")) 
dataset.append((0, "Alguna actividad copada?"))
...
dataset.append((1, "Figura"))
dataset.append((1, "Decime alguna figura importante de acá"))
dataset.append((1, "Alguna figura destacada?"))
dataset.append((1, "Alguna persona interesante"))
dataset.append((1, "Conocido"))
